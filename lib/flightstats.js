...
FlightStats.prototype = {
  ...
  /**
   * Get weather information within a given Airport Code
   * @param {Object} options
   * @param {String} options.airportCode (DXB)
   * @param {Array<String>} [options.extendedOptions]
   * @param {Function} callback
   * @return {Request}
   */
  getWeather: function( options, callback ) {

    var self = this
    var url = '/weather/rest/v1/json/all/' + options.airportCode;
